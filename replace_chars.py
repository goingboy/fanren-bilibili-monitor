...
with open('E:/test_claude/fanren_monitor/chars_gen.html', 'r', encoding='utf-8') as f:
    chars_html = f.read()
...
content = pattern.sub(new_block.replace('\\', '\\\\'), content, count=1)

with open('E:/test_claude/fanren_monitor/templates/wiki.html', 'w', encoding='utf-8') as f:
    f.write(content)

print('Cards:', content.count('wiki-detail-card'))
print('Arc headers in characters tab:', chars_html.count('wiki-arc-header'))
